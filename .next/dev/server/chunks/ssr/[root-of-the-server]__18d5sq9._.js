...
"[project]/src/graphql/postgraphile/queries/roleQueries.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$postgraphile$2f$postgraphileClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/services/postgraphile/postgraphileClient.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$graphql$2f$postgraphile$2f$queries$2f$roleQueries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/graphql/postgraphile/queries/roleQueries.js [app-ssr] (ecmascript)");
;
;
async function getRoles() {
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$postgraphile$2f$postgraphileClient$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchPostGraphile"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$graphql$2f$postgraphile$2f$queries$2f$roleQueries$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GET_ROLE"]);
...
function EmployeeForm({ initialData }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        (async ()=>{
            try {
                const dataRole = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3001/roles');
                setRoles(dataRole.data);
                const dataLevel = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3001/level');
                setLevels(dataLevel.data);
                const dataDepartments = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3001/departments');
                setDepartments(dataDepartments.data);
                if (isEditMode && idEmployee) {
                    (async ()=>{
                        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:3001/employees/${Number(idEmployee)}`);
                        reset({
                            ...data.data,
    ...
    const onSubmit = async (data)=>{
        ...
        if (data.documentUrl && data.documentUrl.length > 0) {
            ...
            if (fileObject.name) {
                ...
                fileNameString = data.documentUrl;
            }
        } else {
        ...
        try {
            if (isEditMode && idEmployee) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`http://localhost:3001/employees/${Number(idEmployee)}`, finalData);
            } else {
                console.log("Gọi API Create với data:", finalData);
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('http://localhost:3001/employees', finalData);
            }
            router.push('/');
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__18d5sq9._.js.map