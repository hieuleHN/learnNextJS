...
(()=>{
    const e = new Error("Cannot find module '../src/services/employeeService'");
...
function EmployeeForm({ initialData }) {
    ...
    const idEmployee = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])().id;
    ...
    const onSubmit = async (data)=>{
        ...
        if (isEditMode) {
            await EmployeeService.console.log("Gọi API Update với data:", finalData);
        } else {
...
_s(EmployeeForm, "jtmJs+2jmdPbU3HWdTZ2xaKcBwk=", false, function() {
    return [
...
//# sourceMappingURL=app_components_EmployeeForm_jsx_08k-57g._.js.map