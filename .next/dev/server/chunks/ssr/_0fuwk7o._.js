        ...
        (async ()=>{
            try {
                ...
                if (isEditMode && idEmployee) {
                    (async ()=>{
                        const data = await axi(Number(idEmployee));
                        reset({
                            ...data,
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            if (isEditMode && idEmployee) {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$postgraphile$2f$employeePostgraphileService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateEmployee"])(Number(idEmployee), finalData);
            } else {
...
//# sourceMappingURL=_0fuwk7o._.js.map