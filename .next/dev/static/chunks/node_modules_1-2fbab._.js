...
"[project]/node_modules/react-router/dist/development/chunk-QUQL4437.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__import$2e$meta__ = {
    get url () {
        return `file://${__turbopack_context__.P("node_modules/react-router/dist/development/chunk-QUQL4437.mjs")}`;
    },
    get turbopackHot () {
...
var DataRoutes = class {
    ...
    /** The stable route tree */ get stableRoutes() {
        return __privateGet(this, _routes);
    }
    /** The in-flight route tree if one is active, otherwise the stable tree */ get activeRoutes() {
        return __privateGet(this, _hmrRoutes) ?? __privateGet(this, _routes);
    }
    /** Pre-computed branches */ get branches() {
        return __privateGet(this, _hmrBranches) ?? __privateGet(this, _branches);
    }
    get hasHMRRoutes() {
        return __privateGet(this, _hmrRoutes) != null;
    }
    /** Replace the stable route tree and recompute its branches */ setRoutes(routes) {
        __privateSet(this, _routes, routes);
        __privateSet(this, _branches, flattenAndRankRoutes(routes));
    }
    /** Set a new in-flight route tree and recompute its branches */ setHmrRoutes(routes) {
        __privateSet(this, _hmrRoutes, routes);
        __privateSet(this, _hmrBranches, flattenAndRankRoutes(routes));
    }
    /** Commit in-flight routes/branches to the stable slot and clear in-flight */ commitHmrRoutes() {
...
function createRouter(init) {
    ...
    if (initialMatches == null && !init.patchRoutesOnNavigation) {
        ...
        if (initialMatches && !init.hydrationData) {
            let fogOfWar = checkFogOfWar(initialMatches, dataRoutes.activeRoutes, init.history.location.pathname);
            if (fogOfWar.active) {
                initialMatches = null;
            }
        }
    ...
    async function startNavigation(historyAction, location, opts) {
        ...
        state.matches : matchRoutesImpl(routesToUse, location, basename, false, dataRoutes.branches);
        let flushSync = (opts && opts.flushSync) === true;
    ...
    async function handleAction(request, location, submission, matches, historyAction, scopedContext, isFogOfWar, initialHydration, opts = {}) {
        interruptActiveLoads();
        let navigation = getSubmittingNavigation(location, matches, historyAction, submission);
        updateState({
            navigation
        }, {
            flushSync: opts.flushSync === true
        ...
        if (!actionMatch.route.action && !actionMatch.route.lazy) {
            ...
            let dsMatches = getTargetedDataStrategyMatches(mapRouteProperties2, manifest, request, location, matches, actionMatch, initialHydration ? [] : hydrationRouteProperties2, scopedContext);
            let results = await callDataStrategy(request, location, dsMatches, scopedContext, null);
    ...
    async function handleFetcherLoader(key, routeId, path, matches, scopedContext, isFogOfWar, flushSync, preventScrollReset, submission) {
        ...
        fetchControllers.set(key, abortController);
        let originatingLoadId = incrementingLoadId;
        let dsMatches = getTargetedDataStrategyMatches(mapRouteProperties2, manifest, fetchRequest, path, matches, match, hydrationRouteProperties2, scopedContext);
        let results = await callDataStrategy(fetchRequest, path, dsMatches, scopedContext, key);
    ...
    async function startRedirectNavigation(request, redirect2, isNavigation, { submission, fetcherSubmission, preventScrollReset, replace: replace2 } = {}) {
        ...
        if (redirectPreserveMethodStatusCodes.has(redirect2.response.status) && activeSubmission && isMutationMethod(activeSubmission.formMethod)) {
            ...
            let overrideNavigation = getLoadingNavigation(redirectLocation, [], redirectNavigationType, submission);
            await startNavigation(redirectNavigationType, redirectLocation, {
                overrideNavigation,
    ...
    async function callLoadersAndMaybeResolveData(matches, fetchersToLoad, request, location, scopedContext) {
        ...
        let fetcherResultsPromise = Promise.all(fetchersToLoad.map(async (f)=>{
            if (f.matches && f.match && f.request && f.controller) {
                let results = await callDataStrategy(f.request, f.path, f.matches, scopedContext, f.key);
    ...
    function checkFogOfWar(matches, routesToUse, pathname) {
        if (init.patchRoutesOnNavigation) {
            ...
            if (!matches) {
                let fogMatches = matchRoutesImpl(routesToUse, pathname, basename, true, activeBranches);
                return {
                    active: true,
                    matches: fogMatches || []
                };
                ...
                if (Object.keys(matches[0].params).length > 0) {
                    let partialMatches = matchRoutesImpl(routesToUse, pathname, basename, true, activeBranches);
                    return {
                        active: true,
    ...
    if (init.instrumentations) {
        router = instrumentClientSideRouter(router, init.instrumentations.map((i)=>i.router).filter(Boolean));
    }
    return router;
}
function createStaticHandler(routes, opts) {
    ...
    async function queryImpl(request, location, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch, filterMatchesToLoad, skipRevalidation) {
        ...
        try {
            if (isMutationMethod(request.method)) {
                let result2 = await submit(request, location, matches, routeMatch || getTargetMatch(matches, location), requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch != null, filterMatchesToLoad, skipRevalidation);
                return result2;
            }
    ...
    async function submit(request, location, matches, actionMatch, requestContext, dataStrategy, skipLoaderErrorBubbling, isRouteRequest, filterMatchesToLoad, skipRevalidation) {
        ...
        if (!actionMatch.route.action && !actionMatch.route.lazy) {
            ...
            let dsMatches = getTargetedDataStrategyMatches(mapRouteProperties2, manifest, request, location, matches, actionMatch, [], requestContext);
        ...
        if (isErrorResult(result)) {
            let boundaryMatch = skipLoaderErrorBubbling ? actionMatch : findNearestBoundary(matches, actionMatch.route.id);
            let handlerContext2 = await loadRouteData(loaderRequest, location, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, null, filterMatchesToLoad, [
                boundaryMatch.route.id,
                result
            ]);
            return {
        ...
        let handlerContext = await loadRouteData(loaderRequest, location, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, null, filterMatchesToLoad);
        return {
            ...handlerContext,
            actionData: {
                [actionMatch.route.id]: result.data
    ...
    async function loadRouteData(request, location, matches, requestContext, dataStrategy, skipLoaderErrorBubbling, routeMatch, filterMatchesToLoad, pendingActionResult) {
        ...
        let dsMatches;
        if (routeMatch) {
            dsMatches = getTargetedDataStrategyMatches(mapRouteProperties2, manifest, request, location, matches, routeMatch, [], requestContext);
        } else {
            ...
            dsMatches = matches.map((match, index)=>{
                if (maxIdx != null && index > maxIdx) {
                    return getDataStrategyMatch(mapRouteProperties2, manifest, request, location, pattern, match, [], requestContext, false);
                }
...
function getMatchesToLoad(request, scopedContext, mapRouteProperties2, manifest, history, state, matches, submission, location, lazyRoutePropertiesToSkip, initialHydration, isRevalidationRequired, cancelledFetcherLoads, fetchersQueuedForDeletion, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, hasPatchRoutesOnNavigation, branches, pendingActionResult, callSiteDefaultShouldRevalidate) {
    ...
    let dsMatches = matches.map((match, index)=>{
        ...
        if (forceShouldLoad !== null) {
            return getDataStrategyMatch(mapRouteProperties2, manifest, request, location, pattern, match, lazyRoutePropertiesToSkip, scopedContext, forceShouldLoad);
        }
    ...
    fetchLoadMatches.forEach((f, key)=>{
        ...
        if (cancelledFetcherLoads.has(key)) {
            ...
            if (shouldRevalidateLoader(fetcherMatch, shouldRevalidateArgs)) {
                fetcherDsMatches = getTargetedDataStrategyMatches(mapRouteProperties2, manifest, fetchRequest, f.path, fetcherMatches, fetcherMatch, lazyRoutePropertiesToSkip, scopedContext, shouldRevalidateArgs);
            }
        }
        if (fetcherDsMatches) {
            revalidatingFetchers.push({
...
async function runMiddlewarePipeline(args, handler, processResult, isResult, errorHandler) {
    ...
    let result = await callRouteMiddleware(dataFnArgs, tuples, handler, processResult, isResult, errorHandler);
    return result;
}
...
Please change the parent <Route path="${parentPath}"> to <Route path="${parentPath === "/" ? "*" : `${parentPath}/*`}">.`);
    ...
    let matches = dataRouterOpts && dataRouterOpts.state.matches.length ? // If we're in a data router, use the matches we've already identified but ensure
...
function useRouterState() {
    let { location, historyAction: type, matches, navigation } = useDataRouterState("unstable_useRouterState" /* UseRouterState */ );
    let active = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useMemo({
        "useRouterState.useMemo[active]": ()=>({
                type,
                location,
                searchParams: new URLSearchParams(location.search),
                params: matches[matches.length - 1]?.params ?? {},
                matches: matches.map({
                    "useRouterState.useMemo[active]": (m)=>toRouterStateMatch(m)
                }["useRouterState.useMemo[active]"])
            })
    }["useRouterState.useMemo[active]"], [
        location,
    ...
    let pending = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useMemo({
        "useRouterState.useMemo[pending]": ()=>{
            ...
            let shared = {
                ...
                matches: navigation.matches.map({
                    "useRouterState.useMemo[pending]": (m)=>toRouterStateMatch(m)
                }["useRouterState.useMemo[pending]"])
            };
...
var MemoizedDataRoutes = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.memo(DataRoutes2);
...
function Router({ basename: basenameProp = "/", children = null, location: locationProp, navigationType = "POP" /* Pop */ , navigator, static: staticProp = false, useTransitions }) {
...
function getPatchRoutesOnNavigationFunction(getRouter, manifest, routeModules, ssr, routeDiscovery, isSpaMode, basename) {
    ...
    return async ({ path, patch, signal, fetcherKey })=>{
        ...
        fetcherKey ? window.location.href : createPath(state.navigation.location || state.location), manifest, routeModules, ssr, isSpaMode, basename, routeDiscovery.manifestPath, patch, signal);
    };
}
...
function getManifestPath(_manifestPath, basename) {
    ...
    return basename == null ? manifestPath : joinPaths([
        basename,
        manifestPath
    ]);
}
...
function PrefetchPageLinks({ page, ...linkProps }) {
    ...
    if (rsc) {
        return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(RSCPrefetchPageLinksImpl, {
            page,
            matches,
            ...linkProps
        });
...
function RSCPrefetchPageLinksImpl({ page, matches: nextMatches, ...linkProps }) {
    ...
    let dataHrefs = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useMemo({
        "RSCPrefetchPageLinksImpl.useMemo[dataHrefs]": ()=>{
...
import(${JSON.stringify(manifest.entry.module)});`;
    ...
    let preloads = isHydrated || isRSCRouterContext ? [] : [
        ...
        ...new Set(manifest.entry.imports.concat(getModuleLinkHrefs(matches, manifest, {
...
try {
    if (isBrowser2) {
        window.__reactRouterVersion = "7.16.0";
    }
} catch (e) {}
...
var Link = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.forwardRef(function LinkWithRef({ onClick, discover = "render", prefetch = "none", relative, reloadDocument, replace: replace2, mask, state, target, to, preventScrollReset, viewTransition, defaultShouldRevalidate, ...rest }, forwardedRef) {
    let { basename, navigator, useTransitions } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useContext(NavigationContext);
...
var Form = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.forwardRef(({ discover = "render", fetcherKey, navigate, reloadDocument, replace: replace2, state, method = defaultMethod, action, onSubmit, relative, preventScrollReset, viewTransition, defaultShouldRevalidate, ...props }, forwardedRef)=>{
    let { useTransitions } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useContext(NavigationContext);
...
function useFetchers() {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.useMemo({
        "useFetchers.useMemo": ()=>Array.from(state.fetchers.entries()).map({
                "useFetchers.useMemo": ([key, fetcher])=>({
                        ...fetcher,
                        key
                    })
            }["useFetchers.useMemo"])
...
"[project]/node_modules/react-router/dist/development/chunk-S54KXAEJ.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 *
 * @license MIT
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/chunk-QUQL4437.mjs [app-client] (ecmascript)");
...
function ServerRouter({ context, url, nonce }) {
    ...
    let routes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createServerRoutes"])(manifest.routes, routeModules, context.future, context.isSpaMode);
    ...
    for (let match of context.staticHandlerContext.matches){
        ...
        if (route && manifestRoute && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldHydrateRouteLoader"])(routeId, route.clientLoader, manifestRoute.hasLoader, context.isSpaMode) && (route.HydrateFallback || !manifestRoute.hasLoader)) {
            delete context.staticHandlerContext.loaderData[routeId];
        }
    }
    let router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStaticRouter"])(routes, context.staticHandlerContext, {
        branches: context.branches
    });
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Fragment, null, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FrameworkContext"].Provider, {
        value: {
            manifest,
            routeModules,
            criticalCss,
    ...
    }, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RemixErrorBoundary"], {
        location: router.state.location
    }, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaticRouterProvider"], {
        router,
        context: context.staticHandlerContext,
        hydrate: false
    }))), context.serverHandoffStream ? /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.Suspense, null, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StreamTransfer"], {
        context,
        identifier: 0,
...
function createRoutesStub(routes, _context) {
    return function RoutesTestStub({ initialEntries, initialIndex, hydrationData, future }) {
        ...
        if (routerRef.current == null) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["convertRoutesToDataRoutes"])(routes, (r)=>r), _context !== void 0 ? _context : future?.v8_middleware ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterContextProvider"]() : {}, frameworkContextRef.current.manifest, frameworkContextRef.current.routeModules);
            routerRef.current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMemoryRouter"])(patched, {
                initialEntries,
                initialIndex,
                hydrationData
            });
        ...
        }, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterProvider"], {
...
function processRoutes(routes, context, manifest, routeModules, parentId) {
    return routes.map((route)=>{
        ...
        let newRoute = {
            ...
            path: route.path,
            index: route.index,
            Component: route.Component ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withComponentProps"])(route.Component) : void 0,
            HydrateFallback: route.HydrateFallback ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withHydrateFallbackProps"])(route.HydrateFallback) : void 0,
            ErrorBoundary: route.ErrorBoundary ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withErrorBoundaryProps"])(route.ErrorBoundary) : void 0,
        ...
        routeModules[route.id] = {
            default: newRoute.Component || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Outlet"],
...
function serializeErrors(errors, serverMode) {
    ...
    let serialized = {};
    for (let [key, val] of entries){
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRouteErrorResponse"])(val)) {
            serialized[key] = {
                ...val,
                __type: "RouteErrorResponse"
            };
...
function matchServerRoutes(manifest, dataRoutes, branches, pathname, basename) {
    let matches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchRoutesImpl"])(dataRoutes, pathname, basename ?? "/", false, branches);
...
async function callRouteHandler(handler, args, future) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDataWithResponseInit"])(result) && result.init && result.init.status && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRedirectStatusCode"])(result.init.status)) {
...
function getBuildTimeHeader(request, headerName) {
    if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] !== "undefined") {
        try {
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.hasOwnProperty("IS_RR_BUILD_REQUEST") && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.IS_RR_BUILD_REQUEST === "yes") {
        ...
        let commonRoute = {
            ...
            loader: route.module.loader ? async (args)=>{
                ...
                if (preRenderedData != null) {
                    ...
                    let decoded = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeViaTurboStream"])(stream, /*TURBOPACK member replacement*/ __turbopack_context__.g);
                    let data2 = decoded.value;
                    if (data2 && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SingleFetchRedirectSymbol"] in data2) {
                        let result = data2[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SingleFetchRedirectSymbol"]];
                        let init = {
                            status: result.status
                        };
                        if (result.reload) {
                            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirectDocument"])(result.redirect, init);
                        } else if (result.replace) {
                            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["replace"])(result.redirect, init);
                        } else {
                            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"])(result.redirect, init);
                        }
                    } else {
                ...
                let val = await callRouteHandler(route.module.loader, args, future);
                return val;
            } : void 0,
...
function createServerHandoffString(serverHandoff) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeHtml"])(JSON.stringify(serverHandoff));
}
;
...
function getNormalizedPath(request, basename, future) {
    ...
    if (future?.v8_trailingSlashAwareDataRequests) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripBasename"])(pathname, basename) === "/_root.data") {
            pathname = basename;
        } else if (pathname.endsWith(".data")) {
            pathname = pathname.replace(/\.data$/, "");
        }
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripBasename"])(pathname, basename) !== "/" && pathname.endsWith("/")) {
...
var SERVER_NO_BODY_STATUS_CODES = /* @__PURE__ */ new Set([
    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NO_BODY_STATUS_CODES"],
    304
]);
async function singleFetchAction(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) {
    ...
    function handleQueryResult(result) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isResponse"])(result) ? result : staticContextToResponse(result);
    }
    ...
    function staticContextToResponse(context) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRedirectStatusCode"])(context.statusCode) && headers.has("Location")) {
            return new Response(null, {
        ...
        if (context.errors) {
            Object.values(context.errors).forEach((err)=>{
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRouteErrorResponse"])(err) || err.error) {
                    handleError(err);
                }
            });
...
function generateSingleFetchRedirectResponse(redirectResponse, request, build, serverMode) {
    ...
    return generateSingleFetchResponse(request, build, serverMode, {
        result: request.method === "GET" ? {
            [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SingleFetchRedirectSymbol"]]: redirect2
        } : redirect2,
        headers,
        status: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SINGLE_FETCH_REDIRECT_STATUS"]
    });
}
function getSingleFetchRedirect(status, headers, basename) {
    let redirect2 = headers.get("Location");
    if (basename) {
        redirect2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripBasename"])(redirect2, basename) || redirect2;
    }
    return {
        redirect: redirect2,
        status,
...
function encodeViaTurboStream(data2, requestSignal, streamTimeout, serverMode) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["encode"])(data2, {
        ...
        plugins: [
            (value)=>{
                ...
                if (value instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"]) {
                ...
                if (value && typeof value === "object" && __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SingleFetchRedirectSymbol"] in value) {
                    return [
                        "SingleFetchRedirect",
                        value[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SingleFetchRedirectSymbol"]]
                    ];
                }
            }
        ],
...
function derive(build, mode) {
    ...
    let staticHandler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStaticHandler"])(dataRoutes, {
    ...
    let errorHandler = build.entry.module.handleError || ((error, { request })=>{
        if (serverMode !== "test" /* Test */  && !request.signal.aborted) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRouteErrorResponse"])(error) && error.error ? error.error : error);
        }
    });
    let requestHandler = async (request, initialContext)=>{
        ...
        if (build.future.v8_middleware) {
            if (initialContext && !(initialContext instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterContextProvider"])) {
            ...
            loadContext = initialContext || new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterContextProvider"]();
        } else {
        ...
        if (!build.ssr) {
            ...
            if (build.basename && build.basename !== "/") {
                let strippedPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripBasename"])(decodedPath, build.basename);
                if (strippedPath == null) {
                    errorHandler(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"](404, "Not Found", `Refusing to prerender the \`${decodedPath}\` path because it does not start with the basename \`${build.basename}\``), {
                        context: loadContext,
                        params,
                        request
                    });
            ...
            if (build.prerender.length === 0) {
                ...
                if (requestUrl.pathname.endsWith(".data")) {
                    errorHandler(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"](404, "Not Found", `Refusing to SSR the path \`${decodedPath}\` because \`ssr:false\` is set and the path is not included in the \`prerender\` config, so in production the path will be a 404.`), {
                        context: loadContext,
                        params,
                        request
                    });
        ...
        let manifestUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getManifestPath"])(build.routeDiscovery.manifestPath, build.basename);
        if (build.routeDiscovery.mode === "lazy" && requestUrl.pathname === manifestUrl) {
            try {
                let res = await handleManifestRequest(build, staticHandler.dataRoutes, staticHandler._internalRouteBranches, requestUrl);
                return res;
            } catch (e) {
                handleError(e);
        ...
        if (requestUrl.pathname.endsWith(".data")) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRedirectResponse"])(response)) {
    ...
    if (build.entry.module.instrumentations) {
        requestHandler = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["instrumentHandler"])(requestHandler, build.entry.module.instrumentations.map((i)=>i.handler).filter(Boolean));
    }
    return {
        serverMode,
        staticHandler,
...
async function handleManifestRequest(build, dataRoutes, branches, url) {
    ...
    if (url.toString().length > __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["URL_LIMIT"]) {
        return new Response(null, {
            statusText: "Bad Request",
            status: 400
        });
...
async function handleSingleFetchRequest(serverMode, build, staticHandler, request, normalizedPath, loadContext, handleError) {
    ...
    let response = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMutationMethod"])(request.method) ? await singleFetchAction(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError) : await singleFetchLoaders(build, serverMode, staticHandler, request, handlerUrl, loadContext, handleError);
    return response;
}
async function handleDocumentRequest(serverMode, build, staticHandler, request, loadContext, handleError, isSpaMode, criticalCss) {
    try {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMutationMethod"])(request.method)) {
            try {
                throwIfPotentialCSRFAttack(request.headers, Array.isArray(build.allowedActionOrigins) ? build.allowedActionOrigins : []);
            } catch (e) {
                handleError(e);
        ...
        let result = await staticHandler.query(request, {
            ...
            generateMiddlewareResponse: build.future.v8_middleware ? async (query)=>{
                try {
                    ...
                    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isResponse"])(innerResult)) {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isResponse"])(result)) {
    ...
    async function renderHtml(context, isSpaMode2) {
        ...
        try {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isResponse"])(error)) {
                try {
                    let data2 = await unwrapResponse(error);
                    errorForSecondRender = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"](error.status, error.statusText, data2);
                } catch (e) {}
            }
            context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getStaticContextFromError"])(staticHandler.dataRoutes, context, errorForSecondRender);
            if (context.errors) {
                context.errors = sanitizeErrors(context.errors, serverMode);
            }
            let state2 = {
...
async function handleResourceRequest(serverMode, build, staticHandler, routeId, request, loadContext, handleError) {
    ...
    function handleQueryRouteError(error) {
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRouteErrorResponse"])(error)) {
            handleError(error);
...
function RSCDefaultRootErrorBoundaryImpl({ error, renderAppShell }) {
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRouteErrorResponse"])(error)) {
        ...
        }, error.status, " ", error.statusText), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ENABLE_DEV_WARNINGS"] ? heyDeveloper : null);
    }
    let errorInstance;
    if (error instanceof Error) {
        errorInstance = error;
...
function RSCDefaultRootErrorBoundary({ hasRootLayout }) {
    let error = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouteError"])();
...
async function routeRSCServerRequest({ request, serverResponse, createFromReadableStream, renderHTML, hydrate = true }) {
    ...
    try {
        ...
        if (serverResponse.status === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SINGLE_FETCH_REDIRECT_STATUS"] && payload.type === "redirect") {
        ...
        let html = await renderHTML(getPayload, {
            onError (error) {
                if (typeof error === "object" && error && "digest" in error && typeof error.digest === "string") {
                    renderRedirect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeRedirectErrorDigest"])(error.digest);
                    if (renderRedirect) {
                        return error.digest;
                    }
                    let routeErrorResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeRouteErrorResponseDigest"])(error.digest);
        ...
        const redirectTransform = new TransformStream({
            flush (controller) {
                if (renderRedirect) {
                    controller.enqueue(new TextEncoder().encode(`<meta http-equiv="refresh" content="0;url=${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeHtml"])(renderRedirect.location)}"/>`));
                }
            }
        });
        if (!hydrate) {
        ...
        try {
            ...
            let [status, statusText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRouteErrorResponse"])(normalizedError) ? [
            ...
            const html = await renderHTML(()=>{
                ...
                onError (error2) {
                    if (typeof error2 === "object" && error2 && "digest" in error2 && typeof error2.digest === "string") {
                        retryRedirect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeRedirectErrorDigest"])(error2.digest);
                        if (retryRedirect) {
                            return error2.digest;
                        }
                        let routeErrorResponse = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeRouteErrorResponseDigest"])(error2.digest);
                        if (routeErrorResponse) {
                            status = routeErrorResponse.status;
                            statusText = routeErrorResponse.statusText;
                            return error2.digest;
            ...
            const retryRedirectTransform = new TransformStream({
                flush (controller) {
                    if (retryRedirect) {
                        controller.enqueue(new TextEncoder().encode(`<meta http-equiv="refresh" content="0;url=${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["escapeHtml"])(retryRedirect.location)}"/>`));
                    }
                }
            });
            if (!hydrate) {
...
function RSCStaticRouter({ getPayload }) {
    ...
    for (const match of payload.matches){
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldHydrateRouteLoader"])(match.id, match.clientLoader, match.hasLoader, false) && (match.hydrateFallbackElement || !match.hasLoader)) {
    ...
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStaticRouter"])(payload.matches.reduceRight((previous, match)=>{
        const route = {
            id: match.id,
            action: match.hasAction || !!match.clientAction,
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__.createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RSCRouterContext"].Provider, {
        value: true
...
function deserializeErrors(errors) {
    ...
    for (let [key, val] of entries){
        if (val && val.__type === "RouteErrorResponse") {
            serialized[key] = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"](val.status, val.statusText, val.data, val.internal === true);
        } else if (val && val.__type === "Error") {
            if (val.__subType) {
                let ErrorConstructor = window[val.__subType];
                if (typeof ErrorConstructor === "function") {
...
function getHydrationData({ state, routes, getRouteInfo, location, basename, isSpaMode }) {
    ...
    let initialMatches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchRoutes"])(routes, location, basename);
    if (initialMatches) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = /*#__PURE__*/ __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/chunk-S54KXAEJ.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/chunk-QUQL4437.mjs [app-client] (ecmascript)");
...
function createHydratedRouter({ getContext, instrumentations }) {
    ...
    if (!ssrInfo.stateDecodingPromise) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"])(stream, "No stream found for single fetch decoding");
        ssrInfo.context.stream = void 0;
        ssrInfo.stateDecodingPromise = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeViaTurboStream"])(stream, window).then((value)=>{
    ...
    let routes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClientRoutes"])(ssrInfo.manifest.routes, ssrInfo.routeModules, ssrInfo.context.state, ssrInfo.context.ssr, ssrInfo.context.isSpaMode);
    ...
    if (ssrInfo.context.isSpaMode) {
        ...
        hydrationData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHydrationData"])({
        ...
        if (hydrationData && hydrationData.errors) {
            hydrationData.errors = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deserializeErrors"])(hydrationData.errors);
        }
    }
    ...
    let router2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRouter"])({
        routes,
        history: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserHistory"])(),
        basename: ssrInfo.context.basename,
        getContext,
        hydrationData,
        hydrationRouteProperties: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hydrationRouteProperties"],
        instrumentations,
        mapRouteProperties: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapRouteProperties"],
        future: {
            v8_passThroughRequests: ssrInfo.context.future.v8_passThroughRequests
        },
        dataStrategy: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTurboStreamSingleFetchDataStrategy"])(()=>router2, ssrInfo.manifest, ssrInfo.routeModules, ssrInfo.context.ssr, ssrInfo.context.basename, ssrInfo.context.future.v8_trailingSlashAwareDataRequests),
        patchRoutesOnNavigation: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPatchRoutesOnNavigationFunction"])(()=>router2, ssrInfo.manifest, ssrInfo.routeModules, ssrInfo.context.ssr, ssrInfo.context.routeDiscovery, ssrInfo.context.isSpaMode, ssrInfo.context.basename)
    });
...
function HydratedRouter(props) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "HydratedRouter.useEffect": ()=>{
            if (("TURBOPACK compile-time value", "development") === "development" && criticalCss === void 0) {
                document.querySelectorAll(`[${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CRITICAL_CSS_DATA_ATTRIBUTE"]}]`).forEach({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"])(ssrInfo, "ssrInfo unavailable for HydratedRouter");
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFogOFWarDiscovery"])(router, ssrInfo.manifest, ssrInfo.routeModules, ssrInfo.context.ssr, ssrInfo.context.routeDiscovery, ssrInfo.context.isSpaMode);
...
function createRouterFromPayload({ fetchImplementation, createFromReadableStream, getContext, payload }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["populateRSCRouteModules"])(globalVar.__reactRouterRouteModules, payload.matches);
    ...
    globalVar.__reactRouterDataRouter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRouter"])({
        routes,
        getContext,
        basename: payload.basename,
        history: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserHistory"])(),
        hydrationData: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHydrationData"])({
            ...
            getRouteInfo: (routeId)=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"])(match, "Route not found in payload");
                return {
...
var renderedRoutesContext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])();
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
    let dataStrategy = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSingleFetchDataStrategyImpl"])(getRouter, (match)=>{
        let M = match;
        return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
    return async (args, basename, trailingSlashAware, targetRoutes)=>{
        let { request, context } = args;
        let url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["singleFetchUrl"])(request.url, basename, trailingSlashAware, "rsc");
        if (request.method === "GET") {
            url = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["stripIndexParam"])(url);
            if (targetRoutes) {
                url.searchParams.set("_routes", targetRoutes.join(","));
            }
        }
        let res = await fetchImplementation(new Request(url, await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRequestInit"])(request)));
        if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"](res.status, res.statusText, await res.text());
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"])(res.body, "No response body to decode");
        try {
            ...
            const dataKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isMutationMethod"])(request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({ createFromReadableStream, fetch: fetchImplementation = fetch, payload, getContext }) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "RSCHydratedRouter.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setIsHydrated"])();
        }
    }["RSCHydratedRouter.useEffect"], []);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"]({
    ...
    return /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RSCRouterContext"].Provider, {
        value: true
    }, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RSCRouterGlobalErrorBoundary"], {
        location: state.location
    }, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FrameworkContext"].Provider, {
        value: frameworkContext
    }, /* @__PURE__ */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterProvider"], {
...
function createRouteFromServerManifest(match, payload) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"])(window.__reactRouterRouteModules);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["populateRSCRouteModules"])(window.__reactRouterRouteModules, match);
    let dataRoute = {
        id: match.id,
        element: match.element,
        errorElement: match.errorElement,
        ...
        action: match.clientAction ? (args, singleFetch)=>match.clientAction({
            ...
            throw (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["noActionDefinedError"])("action", match.id);
        },
        path: match.path,
        shouldRevalidate: match.shouldRevalidate,
    ...
    if (typeof dataRoute.loader === "function") {
        dataRoute.loader.hydrate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldHydrateRouteLoader"])(match.id, match.clientLoader, match.hasLoader, false);
    }
    return dataRoute;
}
function callSingleFetch(singleFetch) {
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"])(typeof singleFetch === "function", "Invalid singleFetch parameter");
    return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
    if (!hasHandler) {
        ...
        console.error(msg);
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"](400, "Bad Request", new Error(msg), true);
    }
}
var nextPaths = /* @__PURE__ */ new Set();
var discoveredPathsMaxSize = 1e3;
...
function hasInvalidProtocol(location2) {
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invalidProtocols"].includes(new URL(location2).protocol);
    } catch  {
        return false;
    }
}
...
"[project]/node_modules/react-router/dist/development/index.mjs [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/react-router/dist/development/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "Await",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Await"],
    "BrowserRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BrowserRouter"],
    "Form",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Form"],
    "HashRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HashRouter"],
    "IDLE_BLOCKER",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDLE_BLOCKER"],
    "IDLE_FETCHER",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDLE_FETCHER"],
    "IDLE_NAVIGATION",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDLE_NAVIGATION"],
    "Link",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Link"],
    "Links",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Links"],
    "MemoryRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MemoryRouter"],
    "Meta",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Meta"],
    "NavLink",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NavLink"],
    "Navigate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Navigate"],
    "NavigationType",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Action"],
    "Outlet",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Outlet"],
    "PrefetchPageLinks",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PrefetchPageLinks"],
    "Route",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Route"],
    "Router",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Router"],
    "RouterContextProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterContextProvider"],
    "RouterProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterProvider"],
    "Routes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Routes"],
    "Scripts",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scripts"],
    "ScrollRestoration",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollRestoration"],
    "ServerRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ServerRouter"],
    "StaticRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaticRouter"],
    "StaticRouterProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaticRouterProvider"],
    "UNSAFE_AwaitContextProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AwaitContextProvider"],
    "UNSAFE_DataRouterContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DataRouterContext"],
    "UNSAFE_DataRouterStateContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DataRouterStateContext"],
    "UNSAFE_ErrorResponseImpl",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ErrorResponseImpl"],
    "UNSAFE_FetchersContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FetchersContext"],
    "UNSAFE_FrameworkContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FrameworkContext"],
    "UNSAFE_LocationContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LocationContext"],
    "UNSAFE_NavigationContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NavigationContext"],
    "UNSAFE_RSCDefaultRootErrorBoundary",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RSCDefaultRootErrorBoundary"],
    "UNSAFE_RemixErrorBoundary",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RemixErrorBoundary"],
    "UNSAFE_RouteContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouteContext"],
    "UNSAFE_ServerMode",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ServerMode"],
    "UNSAFE_SingleFetchRedirectSymbol",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SingleFetchRedirectSymbol"],
    "UNSAFE_ViewTransitionContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ViewTransitionContext"],
    "UNSAFE_WithComponentProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WithComponentProps"],
    "UNSAFE_WithErrorBoundaryProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WithErrorBoundaryProps"],
    "UNSAFE_WithHydrateFallbackProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WithHydrateFallbackProps"],
    "UNSAFE_createBrowserHistory",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserHistory"],
    "UNSAFE_createClientRoutes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClientRoutes"],
    "UNSAFE_createClientRoutesWithHMRRevalidationOptOut",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createClientRoutesWithHMRRevalidationOptOut"],
    "UNSAFE_createHashHistory",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHashHistory"],
    "UNSAFE_createMemoryHistory",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMemoryHistory"],
    "UNSAFE_createRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRouter"],
    "UNSAFE_decodeViaTurboStream",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["decodeViaTurboStream"],
    "UNSAFE_deserializeErrors",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deserializeErrors"],
    "UNSAFE_getHydrationData",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getHydrationData"],
    "UNSAFE_getPatchRoutesOnNavigationFunction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPatchRoutesOnNavigationFunction"],
    "UNSAFE_getTurboStreamSingleFetchDataStrategy",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getTurboStreamSingleFetchDataStrategy"],
    "UNSAFE_hydrationRouteProperties",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hydrationRouteProperties"],
    "UNSAFE_invariant",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["invariant"],
    "UNSAFE_mapRouteProperties",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["mapRouteProperties"],
    "UNSAFE_shouldHydrateRouteLoader",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["shouldHydrateRouteLoader"],
    "UNSAFE_useFogOFWarDiscovery",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFogOFWarDiscovery"],
    "UNSAFE_useScrollRestoration",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useScrollRestoration"],
    "UNSAFE_withComponentProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withComponentProps"],
    "UNSAFE_withErrorBoundaryProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withErrorBoundaryProps"],
    ...
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["withHydrateFallbackProps"],
    "createBrowserRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserRouter"],
    "createContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"],
    "createCookie",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCookie"],
    "createCookieSessionStorage",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCookieSessionStorage"],
    "createHashRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHashRouter"],
    "createMemoryRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMemoryRouter"],
    "createMemorySessionStorage",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMemorySessionStorage"],
    "createPath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPath"],
    "createRequestHandler",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRequestHandler"],
    "createRoutesFromChildren",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRoutesFromChildren"],
    "createRoutesFromElements",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRoutesFromElements"],
    "createRoutesStub",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRoutesStub"],
    "createSearchParams",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSearchParams"],
    "createSession",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSession"],
    "createSessionStorage",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSessionStorage"],
    "createStaticHandler",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStaticHandler2"],
    "createStaticRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStaticRouter"],
    "data",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["data"],
    "generatePath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generatePath"],
    "href",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["href"],
    "isCookie",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCookie"],
    "isRouteErrorResponse",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRouteErrorResponse"],
    "isSession",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSession"],
    "matchPath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchPath"],
    "matchRoutes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchRoutes"],
    "parsePath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePath"],
    "redirect",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"],
    "redirectDocument",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirectDocument"],
    "renderMatches",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["renderMatches"],
    "replace",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["replace"],
    "resolvePath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePath"],
    "unstable_HistoryRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HistoryRouter"],
    "unstable_RSCStaticRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RSCStaticRouter"],
    "unstable_routeRSCServerRequest",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["routeRSCServerRequest"],
    "unstable_setDevServerHooks",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDevServerHooks"],
    "unstable_usePrompt",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePrompt"],
    "unstable_useRoute",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoute"],
    "unstable_useRouterState",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouterState"],
    "useActionData",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useActionData"],
    "useAsyncError",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAsyncError"],
    "useAsyncValue",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAsyncValue"],
    "useBeforeUnload",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBeforeUnload"],
    "useBlocker",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBlocker"],
    "useFetcher",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFetcher"],
    "useFetchers",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFetchers"],
    "useFormAction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormAction"],
    "useHref",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHref"],
    "useInRouterContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInRouterContext"],
    "useLinkClickHandler",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLinkClickHandler"],
    "useLoaderData",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoaderData"],
    "useLocation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocation"],
    "useMatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMatch"],
    "useMatches",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMatches"],
    "useNavigate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigate"],
    "useNavigation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigation"],
    "useNavigationType",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigationType"],
    "useOutlet",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOutlet"],
    "useOutletContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOutletContext"],
    "useParams",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
    "useResolvedPath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useResolvedPath"],
    "useRevalidator",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRevalidator"],
    "useRouteError",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouteError"],
    "useRouteLoaderData",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouteLoaderData"],
    "useRoutes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoutes"],
    "useSearchParams",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"],
    "useSubmit",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSubmit"],
    "useViewTransitionState",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useViewTransitionState"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$S54KXAEJ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/chunk-S54KXAEJ.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$chunk$2d$QUQL4437$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/chunk-QUQL4437.mjs [app-client] (ecmascript)");
}),
"[project]/node_modules/react-router-dom/dist/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "Await",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Await"],
    "BrowserRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BrowserRouter"],
    "Form",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Form"],
    "HashRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HashRouter"],
    "HydratedRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$dom$2d$export$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HydratedRouter"],
    "IDLE_BLOCKER",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDLE_BLOCKER"],
    "IDLE_FETCHER",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDLE_FETCHER"],
    "IDLE_NAVIGATION",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IDLE_NAVIGATION"],
    "Link",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Link"],
    "Links",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Links"],
    "MemoryRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MemoryRouter"],
    "Meta",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Meta"],
    "NavLink",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NavLink"],
    "Navigate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Navigate"],
    "NavigationType",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NavigationType"],
    "Outlet",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Outlet"],
    "PrefetchPageLinks",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PrefetchPageLinks"],
    "Route",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Route"],
    "Router",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Router"],
    "RouterContextProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterContextProvider"],
    "RouterProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$dom$2d$export$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RouterProvider"],
    "Routes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Routes"],
    "Scripts",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scripts"],
    "ScrollRestoration",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollRestoration"],
    "ServerRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ServerRouter"],
    "StaticRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaticRouter"],
    "StaticRouterProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StaticRouterProvider"],
    "UNSAFE_AwaitContextProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_AwaitContextProvider"],
    "UNSAFE_DataRouterContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_DataRouterContext"],
    "UNSAFE_DataRouterStateContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_DataRouterStateContext"],
    "UNSAFE_ErrorResponseImpl",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_ErrorResponseImpl"],
    "UNSAFE_FetchersContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_FetchersContext"],
    "UNSAFE_FrameworkContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_FrameworkContext"],
    "UNSAFE_LocationContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_LocationContext"],
    "UNSAFE_NavigationContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_NavigationContext"],
    "UNSAFE_RSCDefaultRootErrorBoundary",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_RSCDefaultRootErrorBoundary"],
    "UNSAFE_RemixErrorBoundary",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_RemixErrorBoundary"],
    "UNSAFE_RouteContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_RouteContext"],
    "UNSAFE_ServerMode",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_ServerMode"],
    "UNSAFE_SingleFetchRedirectSymbol",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_SingleFetchRedirectSymbol"],
    "UNSAFE_ViewTransitionContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_ViewTransitionContext"],
    "UNSAFE_WithComponentProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_WithComponentProps"],
    "UNSAFE_WithErrorBoundaryProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_WithErrorBoundaryProps"],
    "UNSAFE_WithHydrateFallbackProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_WithHydrateFallbackProps"],
    "UNSAFE_createBrowserHistory",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_createBrowserHistory"],
    "UNSAFE_createClientRoutes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_createClientRoutes"],
    "UNSAFE_createClientRoutesWithHMRRevalidationOptOut",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_createClientRoutesWithHMRRevalidationOptOut"],
    "UNSAFE_createHashHistory",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_createHashHistory"],
    "UNSAFE_createMemoryHistory",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_createMemoryHistory"],
    "UNSAFE_createRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_createRouter"],
    "UNSAFE_decodeViaTurboStream",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_decodeViaTurboStream"],
    "UNSAFE_deserializeErrors",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_deserializeErrors"],
    "UNSAFE_getHydrationData",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_getHydrationData"],
    "UNSAFE_getPatchRoutesOnNavigationFunction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_getPatchRoutesOnNavigationFunction"],
    "UNSAFE_getTurboStreamSingleFetchDataStrategy",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_getTurboStreamSingleFetchDataStrategy"],
    "UNSAFE_hydrationRouteProperties",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_hydrationRouteProperties"],
    "UNSAFE_invariant",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_invariant"],
    "UNSAFE_mapRouteProperties",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_mapRouteProperties"],
    "UNSAFE_shouldHydrateRouteLoader",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_shouldHydrateRouteLoader"],
    "UNSAFE_useFogOFWarDiscovery",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_useFogOFWarDiscovery"],
    "UNSAFE_useScrollRestoration",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_useScrollRestoration"],
    "UNSAFE_withComponentProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_withComponentProps"],
    "UNSAFE_withErrorBoundaryProps",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_withErrorBoundaryProps"],
    ...
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UNSAFE_withHydrateFallbackProps"],
    "createBrowserRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrowserRouter"],
    "createContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"],
    "createCookie",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCookie"],
    "createCookieSessionStorage",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCookieSessionStorage"],
    "createHashRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createHashRouter"],
    "createMemoryRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMemoryRouter"],
    "createMemorySessionStorage",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createMemorySessionStorage"],
    "createPath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPath"],
    "createRequestHandler",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRequestHandler"],
    "createRoutesFromChildren",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRoutesFromChildren"],
    "createRoutesFromElements",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRoutesFromElements"],
    "createRoutesStub",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRoutesStub"],
    "createSearchParams",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSearchParams"],
    "createSession",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSession"],
    "createSessionStorage",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSessionStorage"],
    "createStaticHandler",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStaticHandler"],
    "createStaticRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createStaticRouter"],
    "data",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["data"],
    "generatePath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generatePath"],
    "href",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["href"],
    "isCookie",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCookie"],
    "isRouteErrorResponse",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isRouteErrorResponse"],
    "isSession",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isSession"],
    "matchPath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchPath"],
    "matchRoutes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["matchRoutes"],
    "parsePath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parsePath"],
    "redirect",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirect"],
    "redirectDocument",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["redirectDocument"],
    "renderMatches",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["renderMatches"],
    "replace",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["replace"],
    "resolvePath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolvePath"],
    "unstable_HistoryRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unstable_HistoryRouter"],
    "unstable_RSCStaticRouter",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unstable_RSCStaticRouter"],
    "unstable_routeRSCServerRequest",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unstable_routeRSCServerRequest"],
    "unstable_setDevServerHooks",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unstable_setDevServerHooks"],
    "unstable_usePrompt",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unstable_usePrompt"],
    "unstable_useRoute",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unstable_useRoute"],
    "unstable_useRouterState",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["unstable_useRouterState"],
    "useActionData",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useActionData"],
    "useAsyncError",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAsyncError"],
    "useAsyncValue",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAsyncValue"],
    "useBeforeUnload",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBeforeUnload"],
    "useBlocker",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useBlocker"],
    "useFetcher",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFetcher"],
    "useFetchers",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFetchers"],
    "useFormAction",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormAction"],
    "useHref",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useHref"],
    "useInRouterContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInRouterContext"],
    "useLinkClickHandler",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLinkClickHandler"],
    "useLoaderData",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLoaderData"],
    "useLocation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLocation"],
    "useMatch",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMatch"],
    "useMatches",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMatches"],
    "useNavigate",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigate"],
    "useNavigation",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigation"],
    "useNavigationType",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNavigationType"],
    "useOutlet",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOutlet"],
    "useOutletContext",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOutletContext"],
    "useParams",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"],
    "useResolvedPath",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useResolvedPath"],
    "useRevalidator",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRevalidator"],
    "useRouteError",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouteError"],
    "useRouteLoaderData",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouteLoaderData"],
    "useRoutes",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoutes"],
    "useSearchParams",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSearchParams"],
    "useSubmit",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSubmit"],
    "useViewTransitionState",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useViewTransitionState"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2d$dom$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/react-router-dom/dist/index.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$dom$2d$export$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/dom-export.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$router$2f$dist$2f$development$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-router/dist/development/index.mjs [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=node_modules_1-2fbab._.js.map