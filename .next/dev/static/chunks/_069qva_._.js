        ...
        "EmployeeForm.useEffect": ()=>{
            ({
                "EmployeeForm.useEffect": async ()=>{
                    try {
                        const dataRole = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3001/roles');
                        setRoles(dataRole.data);
                        const dataLevel = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3001/level');
                        setLevels(dataLevel.data);
                        const dataDepartments = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('http://localhost:3001/departments');
                        setDepartments(dataDepartments.data);
                        if (isEditMode && idEmployee) {
                            ({
                                "EmployeeForm.useEffect": async ()=>{
                                    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:3001/employees/${Number(idEmployee)}`);
                                    reset({
                                        ...data.data,
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            if (isEditMode && idEmployee) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`http://localhost:3001/employees/${Number(idEmployee)}`, finalData);
            } else {
                console.log("Gọi API Create với data:", finalData);
                await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:3001/employees', finalData);
            }
            router.push('/');
        } catch (err) {
...
_s(EmployeeForm, "lDQ3aHZUn6FdZwuRy9P5U6+GgKI=", false, function() {
    return [
...
//# sourceMappingURL=_069qva_._.js.map